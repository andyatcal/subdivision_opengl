...
Elements store two types of data: self-information and adjacency information, where the adjacency includes within a face and between faces. As shown in Table \ref{table:vhfInfo}. 
%Table2
\begin{table}[ht]
\centering
\begin{tabular}{| l | p{0.4\textwidth} | p{0.4\textwidth}|}
...
There are two types of face connections, the normal connection and the mobius connection, as shown in Figure \ref{figure:faceConnections}. In a typical halfedge data structure, the pair of halfedges between two faces are defined with opposite direction. The author extend this idea and add another type of connection In a normal connection, the pair of halfedges between two faces are in opposite direction. In the mobius connection, the pair are in same direction.
